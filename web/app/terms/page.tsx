...
export const metadata: Metadata = {
	...
	description:
		"The terms that govern your access to and use of pylonsync.com and Pylon Cloud.",
	canonical: "/terms",
	robots: "index,follow",
	openGraph: {
		title: "Terms of Service — Pylon",
		description: "The terms governing Pylon Cloud.",
...
export default function TermsPage({
	...
	return (
		<LegalPage
			...
			intro={
				'These Terms of Service ("Terms") govern your access to and use of pylonsync.com and the Pylon Cloud hosting service (the "Service"), operated by Pylon. By creating an account or using the Service, you agree to these Terms. If you use the Service on behalf of an organization, you represent that you have authority to bind it.'
			}
		>
			<LegalSection heading="1. The Service">
				<p>
					Pylon Cloud is a hosted platform for building, deploying, and running
