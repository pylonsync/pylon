...
main tab aggregates samples and shows live throughput and latency
percentiles. It runs entirely in the browser.

## What this example demonstrates

- **Throughput measurement.** Workers run in separate threads
...
Sample a few configurations on your hardware and network:
...
For higher write throughput than SQLite's single-writer ceiling, set `DATABASE_URL=postgres://...` and rerun the same bench against Postgres.
