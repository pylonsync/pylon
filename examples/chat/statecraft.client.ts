...
export type EntityName = "User" | "Channel" | "Membership" | "Message" | "Reaction" | "ReadMarker";

export const ENTITIES: EntityName[] = ["User", "Channel", "Membership", "Message", "Reaction", "ReadMarker"];
