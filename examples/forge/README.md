...
- **Native SSR.** One binary serves the frontend and API on a single port.
...
- Large scenes put more pressure on the mesh-pool lifecycle than sync.
  Pylon delivers changes in milliseconds; Three.js is the dominant cost.
