...
export type EntityName = "User" | "Organization" | "OrgMember" | "OrgInvite" | "Customer" | "Product" | "ProductOption" | "Material" | "StockMovement" | "Quote" | "QuoteLine" | "Order" | "OrderLine" | "DashboardPanel";

export const ENTITIES: EntityName[] = ["User", "Organization", "OrgMember", "OrgInvite", "Customer", "Product", "ProductOption", "Material", "StockMovement", "Quote", "QuoteLine", "Order", "OrderLine", "DashboardPanel"];
...
// ---------------------------------------------------------------------------
// AppSchema — types consumed by @statecraft/react's createTypedDb<S>()
// ---------------------------------------------------------------------------
...
/** Top-level app schema — pass to @statecraft/react's createTypedDb<AppSchema>(). */
