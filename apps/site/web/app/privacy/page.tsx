...
export const metadata: Metadata = {
	...
	description:
		"How Pylon collects, uses, shares, and protects your information when you use pylonsync.com and Stack0 Cloud.",
	canonical: "/privacy",
	robots: "index,follow",
	openGraph: {
		title: "Privacy Policy — Pylon",
...
export default function PrivacyPage({
	...
	return (
		<LegalPage
			...
			intro={
				'This Privacy Policy explains how Pylon ("Pylon", "we", "us") collects, uses, discloses, and protects information when you visit pylonsync.com or use Stack0 Cloud (together, the "Service"). By using the Service you agree to this Policy.'
			}
		>
