...
| Pricing model | Self-host infra or Stack0 Cloud plan + machine compute | Hosted usage + team seats; self-host infra | Hosted tiers or self-host infra | Hosted pay-as-you-go meters |
...
If you are already on a competitor and considering a move:
