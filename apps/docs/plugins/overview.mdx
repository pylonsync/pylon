...
| **[@pylonsync/organizations](/plugins/organizations)** | Permission system + team support layered on the framework's entity-based orgs. | Framework has Org primitives; this adds the permission layer + teams. |
