...
description: "Choose a Pylon SDK for TypeScript, React, React Native, Next.js, Swift, sync, or Loro."
---
...
| **[`@pylonsync/sync`](/clients/sync)** | The sync engine: local store, mutation queue, and WebSocket/SSE/poll transports. Every JS SDK uses it. You can also use it standalone in non-React apps. |
...
Pick your platform: [TypeScript](/clients/typescript), [React](/clients/react), [React Native](/clients/react-native), [Next.js](/clients/next), [Swift](/clients/swift), [sync engine](/clients/sync), or [Loro CRDTs](/clients/loro).
