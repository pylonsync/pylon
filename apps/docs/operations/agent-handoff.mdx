...
```
I just signed up for Stack0 Cloud and want you to help me build. Please run these steps in order:

1. Install the Pylon CLI:
   curl -fsSL https://www.pylonsync.com/install.sh | bash

2. Sign in to my Stack0 Cloud account (single-use code, expires in 5 min):
...
https://<slug>.stack0.app, and sets it as the working context. To target
