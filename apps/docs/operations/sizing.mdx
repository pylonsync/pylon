...
Cloud autoscales the HTTP, WebSocket, and shard tiers separately. You do not pre-provision; you pay for what you use. The numbers above are useful for self-hosted capacity planning. On Cloud, you do not need to think about them.
