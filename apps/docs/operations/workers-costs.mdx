...
Idle Workers apps cost $0 because deployments scale to zero. This page covers the cases that cost money: scale-to-zero tradeoffs, runaway request patterns, and bill caps.
