...
On Pylon Cloud, magic-link email is included. You need no provider config for the built-in sender. Configure your own domain in `Settings → Email` for production to keep deliverability high.
