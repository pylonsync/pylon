//! Fuzz and property-based tests for agentdb parsers and data structures.
//!
...
use agentdb_plugin::builtin::file_storage::FileStoragePlugin;
use agentdb_runtime::cron::CronExpr;
use agentdb_runtime::resp::parse_resp;
...
fn resp_roundtrip_property() {
    use agentdb_runtime::resp::RespValue;
...
fn file_storage_rejects_traversal_variants() {
    let dir = std::env::temp_dir().join("agentdb_fuzz_file_storage");
