//! Remote cache client.
//!
//! Connects to a standalone agentdb cache server over HTTP. Provides the
...
//!
//! ```rust,ignore
//! use agentdb_plugin::builtin::cache_client::RemoteCacheClient;
//!
...
/// A client that connects to a remote agentdb cache server.
///
