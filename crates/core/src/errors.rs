...
pub const ALL_CODES: &[&str] = &[
    AUTH_REQUIRED, AUTH_UPGRADE_FAILED, INVALID_CODE, OAUTH_INVALID_STATE,
    OAUTH_TOKEN_EXCHANGE_FAILED, PROVIDER_NOT_FOUND, SESSION_EXPIRED,
    SESSION_NOT_FOUND, FORBIDDEN, POLICY_DENIED, UNAUTHORIZED,
    INVALID_JSON, INVALID_ARGS, INVALID_COLUMN, INVALID_QUERY, INVALID_DATA,
    INVALID_FILE_ID, MISSING_EMAIL, MISSING_USER_ID, MISSING_CODE,
    MISSING_FIELD, MISSING_ROOM, MISSING_TOPIC, MISSING_NAME,
    MISSING_OPERATIONS, PAYLOAD_TOO_LARGE,
    NOT_FOUND, ENTITY_NOT_FOUND, ACTION_NOT_FOUND, FN_NOT_FOUND, FILE_NOT_FOUND,
    SHARD_NOT_FOUND, RELATION_NOT_FOUND,
    QUERY_FAILED, INSERT_FAILED, UPDATE_FAILED, DELETE_FAILED,
    SCHEMA_INIT_FAILED, LOCK_FAILED, NESTED_TRANSACTION, EXPORT_FAILED,
    NOT_SUPPORTED, NOT_IMPLEMENTED, NOT_AVAILABLE,
    RATE_LIMITED, METHOD_NOT_ALLOWED, PROTOCOL_ERROR, RUNNER_EXITED,
    RUNNER_NOT_STARTED, IO_ERROR, AI_NOT_CONFIGURED, AI_REQUEST_FAILED,
    EMAIL_SEND_FAILED,
    WORKFLOW_START_FAILED, WORKFLOW_ADVANCE_FAILED, WORKFLOW_EVENT_FAILED,
    WORKFLOW_CANCEL_FAILED, INPUT_REJECTED, SUBSCRIBE_FAILED,
