/**
 * Typed database client — narrow statecraft's untyped `db` object using your
 * generated `AppSchema` (from `statecraft codegen client`).
 *
 * @example
 * ```ts
 * // src/statecraft.client.ts (generated by `statecraft codegen client`)
 ...
 *
 * // src/db.ts
 * import { createTypedDb } from "@statecraft/react";
 * import type { AppSchema } from "./statecraft.client";
...
import type { Row } from "@statecraft/sync";
