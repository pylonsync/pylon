#!/usr/bin/env node
/**
 * create-pylon — scaffold a new Pylon app.
 *
 * Run via `npm create pylon@latest [name]` (or yarn/pnpm/bun create pylon).
 *
...
if (flags.help) {
	process.stdout.write(`\nUsage: npm create pylon [name] [--bun|--pnpm|--yarn|--npm] [--skip-install]\n\n`);
	exit(0);
}
