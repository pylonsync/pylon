...
// here: the studio mints an anonymous guest session so anyone can generate, and
// without persisting the real session that stale guest token would shadow it —
// your guest gallery wouldn't migrate to your account. We then do a full
// navigation to "/" so the SSR runtime re-resolves auth from the HttpOnly cookie.
//
// Sign-in is OPTIONAL: a guest can generate immediately. Signing in just makes
// your gallery follow you across devices (it's owner-scoped to your id).
