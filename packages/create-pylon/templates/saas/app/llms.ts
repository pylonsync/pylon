...
export default function llms(): LlmsTxt {
  return {
    title: "__APP_NAME__",
    summary: "A multi-tenant SaaS product: organizations, members, projects, and billing.",
    details: [
      "Use this app to sign up an organization, invite members, and manage projects. Billing runs through Stripe Checkout.",
