...
export default function llms(): LlmsTxt {
  return {
    title: "__APP_NAME__",
    summary: "A shared todo list with live updates.",
    details: [
      "Use this app to add, complete, and delete todos. A guest session is created on the first visit, so there is no sign-up step.",
