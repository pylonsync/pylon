...
export default function llms(): LlmsTxt {
  return {
    title: "__APP_NAME__",
    summary: "A storefront with a cart and Stripe checkout.",
    details: [
      "Use this app to browse products, add them to a cart, and check out. Stock is decremented when an order is paid.",
    ...
    sections: [
      {
        ...
        links: [
          { title: "Home", url: `${SITE}` },
          { title: "Success", url: `${SITE}/success` },
        ],
      },
    ],
  };
