...
export default function llms(): LlmsTxt {
  return {
    title: "__APP_NAME__",
    summary: "A submission-based directory with search and categories.",
    details: [
      "Use this app to search listings by category and to submit a new listing for review.",
