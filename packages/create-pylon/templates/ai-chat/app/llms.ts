...
export default function llms(): LlmsTxt {
  return {
    title: "__APP_NAME__",
    summary: "An AI chat app with streaming answers and stored transcripts.",
    details: [
      "Use this app to ask a question and read the streamed answer. Transcripts persist across reloads and devices.",
