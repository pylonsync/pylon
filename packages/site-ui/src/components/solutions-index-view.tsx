				...
				<div className="grid gap-4 sm:grid-cols-2">
					{SOLUTIONS.map((s) => {
						...
						return (
							...
							>
								{Icon && (
									<span className="mb-4 flex size-10 items-center justify-center rounded-[var(--radius-md)] border border-[var(--color-rule)] bg-[var(--color-paper)] text-[var(--color-brand)]">
