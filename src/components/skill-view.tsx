...
function CopyBlock({ command }: { command: string }) {
	...
	return (
		<button
			...
			className="group flex w-full items-start gap-3 overflow-x-auto rounded-[var(--radius-md)] border border-[var(--color-rule)] bg-[#0c0d10] px-4 py-3 text-left font-mono text-[12.5px] leading-[1.6] text-[var(--color-ink)] transition-colors hover:border-[var(--color-cobalt)]/50"
		>
